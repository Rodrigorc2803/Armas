...
namespace Arma
{
    internal class Escopeta : Program
    {
        ...
        public virtual float VelocidadAtaque(float VelocidadDeAtaque)
        {
            ...
            float Velocidad = velocidad.Next(28, 35);
        ...
        public virtual string Municion(string Proyectil)
        {
            ...
            string bala = "Perdigon de Escopeta";
            Proyectil = bala;
            return Proyectil;
        }
